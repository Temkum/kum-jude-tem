    ...
    <header id="welcome">
      <div className="container header__container">
        <div className="landing__text">
          ...
          <p>
            Helping people turn their ideas
            <br /> into sites & apps with results. <br />
          ...
          <div className="cta-container">
            ...
            <div className="cta-social-icons">
              <a
                aria-label="Find Kum on LinkedIn"
                title="Find Kum on LinkedIn"
              ...
              <a
                title="Find Kum Jude on Twitter"
                aria-label="Find Kum on Twitter"
                className="landing-icons icon twitter"
              ...
              <a
                aria-label="See Kum's Code on Github"
                title="See Kum's Code on Github"
                className="landing-icons icon px-4"
                href="https://github.com/Temkum"
                target="_blank"
                rel="noopener noreferrer"
              >
                <Github />
